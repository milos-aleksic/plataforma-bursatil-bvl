                        ...
                        <div class="uk-card-header">
                            <div class="uk-grid uk-grid-small uk-text-small" data-uk-grid>
                                <div class="uk-width-expand">
                                    <span class="cat-txt  uk-text-bold"> <span v-if="cierreshoy" uk-icon="star"></span>{{cierreshoy}} {{companyName}} ({{companyCode}})</span>
                                </div>
                        ...
                        <div class="uk-card-body">
                            ...
                            <div class="uk-text-center uk-grid uk-grid-small uk-child-width-1-2 uk-grid-divider" data-uk-grid>
                                ...
                                <div v-if="stock.length">
                                    ...
                                    <div>
                                        {{stock[0]}}
                                        <span v-if="stock.length > 1" class="uk-text-danger uk-text-small" v-bind:data-uk-tooltip="stock.join(',')">
                                            (+{{stock.length - 1}})
                                        </span>
                                    </div>
                                ...
                                <div v-if="fixedValues.length">
                                    ...
                                    <div>{{fixedValues[0]['nemonico']}} 
                                        <span v-if="fixedValues.length > 1" class="uk-text-danger uk-text-small" v-bind:data-uk-tooltip="fixedValues.map(item => item.nemonico).join(', ')">
